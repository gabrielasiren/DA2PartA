...
aggtTest <- cbind("Aggregate",aggtTest)
...
|   The population mean for income at an aggregate level has a confidence interval with a Lower Confidence Limit (LCL) of 49980.80 and Upper Confidence Limit (UCL) of 53821.89. The population mean lies within this interval with 90% confidence.
...
kable(proportionC,
      caption = "Proportion per Segment",
...
kable(pTable,
      caption ="90% C.I for the population proportion of Subscribers in the Urban Hip",
        format="simple", digits = 2
      )
